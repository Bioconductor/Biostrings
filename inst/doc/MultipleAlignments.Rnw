...
functions to read clustaW and Stolkholm data formats.
...
If you need to write your \Rclass{MultipleAlignment} object out to a
file again, you can cast it to a \Rclass{DNAStringSet} and then write
it out as a fasta file.
