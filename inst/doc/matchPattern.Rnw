...
Note that \Robject{Celegans\$chrI} is a \Rclass{BStringViews} object with a
single view (\Robject{length(Celegans\$chrI)} is 1).
...
<<a4>>=
length(Celegans$upstream2000)
length(Celegans$upstream2000[[1]])
@
